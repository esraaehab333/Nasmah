        ...
        NavigationStack {
            ZStack {
                ...
                Group {
                    if vm.savedLocations.isEmpty {
                        ...
                        FavoritesListView(vm: vm, onCitySelected: onCitySelected)
                    }
                }
                .animation(.easeInOut(duration: 0.25), value: vm.savedLocations.isEmpty)
            }
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    if !vm.savedLocations.isEmpty {
                        EditButton().foregroundStyle(vm.accentColor)
                    }
                }
            }
